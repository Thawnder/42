...
/*   Updated: 2023/10/25 18:14:09 by bpleutin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	*init_all(t_data *data, char **argv, int i)
{
	...
	return (sem_unlink("forks"), sem_unlink("write"), sem_unlink("start"),
		sem_unlink("end"), sem_unlink("die"), sem_unlink("last"),
		sem_unlink("state"), sem_unlink("meal"), sem_unlink("is_dead"),
		data->info.start_time = get_time(), (void *)0);
}
